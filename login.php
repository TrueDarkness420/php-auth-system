...
if(isset($_POST['submit'])) {
    ...
    if($stmt->rowCount() == 0) {
        ...
        $rows = $stmt->fetch();
        $databaseGrab = $rows['password'];
        if(password_verify($password, $databaseGrab)) {
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="../assets/css/themify-1.css">

    <!-- slick icon-->
    <link rel="stylesheet" type="text/css" href="../assets/css/slick-1.css">
    <link rel="stylesheet" type="text/css" href="../assets/css/slick-theme-1.css">
...
<g>
	<path style="fill:#E6E6E6;" d="M468.52,102.595v251.88c0,11.14-7.571,20.52-17.86,23.25c-1.98,0.531-4.06,0.81-6.2,0.81H38.58
		...
		C460.949,82.075,468.52,91.455,468.52,102.595"></path>
	<path style="fill:#B3B3B3;" d="M468.518,102.591v23.94h-454v-23.94c0-13.29,10.771-24.06,24.06-24.06h405.88
		C457.747,78.532,468.518,89.302,468.518,102.591"></path>
	<rect x="42.099" y="141.002" style="fill:#999999;" width="118.901" height="16.532"></rect>
	<polyline style="fill:#FFFFFF;" points="442.383,222.765 256.652,222.765 256.652,354.496 442.383,354.496 442.383,222.765 	"></polyline>
	<polyline style="fill:#13c9ca;" points="434.552,329.733 265.552,329.733 265.552,346.265 434.552,346.265 434.552,329.733 	"></polyline>
	<polyline style="fill:#a5a5a5;" points="286.552,297.744 265.552,297.744 265.552,314.276 286.552,314.276 286.552,297.744 	"></polyline>
	<polyline style="fill:#ffbc58;" points="350.552,265.754 265.552,265.754 265.552,282.286 350.552,282.286 350.552,265.754 	"></polyline>
	<polyline style="fill:#999999;" points="411.552,233.765 265.552,233.765 265.552,250.297 411.552,250.297 411.552,233.765 	"></polyline>
	<circle style="fill:#a5a5a5;" cx="47.517" cy="102.532" r="15"></circle>
	<circle style="fill:#ffbc58;" cx="87.517" cy="102.532" r="15"></circle>
	<path style="fill:#EEEEEE;" d="M463.696,88.139c3.027,4.024,4.822,9.029,4.822,14.453v23.94h-23.321
		...
		C463.596,88.007,463.593,88.003,463.59,87.999"></path>
	<path style="fill:#CBCBCB;" d="M444.46,78.535h-11.739c0.396,0.716,0.784,1.437,1.165,2.167c7.655,14.662,11.293,30.36,11.31,45.83
		...
		C448.68,78.815,446.6,78.535,444.46,78.535"></path>
	<path style="fill:#FFFFFF;" d="M442.383,222.765h-54.222l5.326,10.202c-0.519,0.271-1.04,0.537-1.561,0.798h19.626v16.532H266.807
		...
		V222.765"></path>
	<polyline style="fill:#6EC6EB;" points="434.552,329.733 291.016,329.733 296.055,346.265 434.552,346.265 434.552,329.733 	"></polyline>
	<polyline style="fill:#FDA589;" points="286.552,297.744 281.267,297.744 286.306,314.276 286.552,314.276 286.552,297.744 	"></polyline>
	<polyline style="fill:#FBE98E;" points="350.552,265.754 271.518,265.754 276.556,282.286 350.552,282.286 350.552,265.754 	"></polyline>
	<path style="fill:#EEEEEE;" d="M246.265,126.531h-17.178l29.329,96.234h62.908c-1.465-0.282-2.926-0.591-4.384-0.929l-1.001-0.232
		c-24.282-7.625-45.651-24.51-58.362-48.855C249.857,157.962,246.221,142.128,246.265,126.531"></path>
	<path style="fill:#CBCBCB;" d="M258.73,78.535h-44.27l14.628,47.996h17.178c0.028-10.08,1.594-20.062,4.587-29.594
		C252.852,90.569,255.489,84.4,258.73,78.535"></path>
	<path style="fill:#FFFFFF;" d="M321.324,222.765h-62.908l7.136,23.415v-12.415h53.983l3.362-10.708
		C322.373,222.963,321.848,222.866,321.324,222.765"></path>
	<path style="fill:#BABABA;" d="M411.552,233.765h-19.626c-14.25,7.129-29.421,10.514-44.383,10.514
		c-10.173,0-20.251-1.566-29.869-4.586l1.861-5.928h-53.983v12.415l1.255,4.117h144.745V233.765"></path>
	<path style="fill:#CECECE;" d="M385.387,217.453c-6.196,2.3-12.551,4.073-18.994,5.313h21.767L385.387,217.453"></path>
	<path style="fill:#DBDBDB;" d="M388.161,222.765h-21.767c-7.428,1.428-14.973,2.147-22.536,2.147
		c-6.999,0-14.015-0.616-20.959-1.855l-3.362,10.708h72.391c0.521-0.261,1.042-0.527,1.561-0.798L388.161,222.765"></path>
	<path style="fill:#A4A4A4;" d="M391.926,233.765h-72.391l-1.861,5.928c9.618,3.02,19.696,4.586,29.869,4.586
		C362.505,244.279,377.677,240.894,391.926,233.765"></path>
	<path style="fill:#DBDBDB;" d="M345.64,27.261c-15.507,0-31.24,3.637-45.936,11.309c-17.955,9.374-31.855,23.466-40.973,39.961
		h173.987c-12.828-23.18-33.641-39.288-57.199-46.682C365.898,28.829,355.817,27.261,345.64,27.261"></path>
	<polyline style="fill:#9F9F9F;" points="432.719,78.532 258.732,78.532 258.73,78.535 432.721,78.535 432.719,78.532 	"></polyline>
	<path style="fill:#CECECE;" d="M445.196,126.531H246.265c-0.044,15.597,3.592,31.43,11.312,46.218
		...
		c6.443-1.239,12.797-3.012,18.994-5.313c2.142-0.795,4.263-1.653,6.365-2.574C425.776,197.115,445.237,162.431,445.196,126.531"></path>
	...
	<path style="fill:#a5a5a5;" d="M391.75,201.375l-46.02-88.15l-11.42-3.59l-83.46-26.2c7.63-24.29,24.51-45.66,48.85-58.37
		...
		C459.3,115.885,440.44,175.955,391.75,201.375z"></path>
	<polyline style="fill:#FFFFFF;" points="226.383,168.765 40.652,168.765 40.652,354.496 226.383,354.496 226.383,168.765 	"></polyline>
	<polyline style="fill:#2BE0C6;" points="93.6,254.001 57.602,254.001 57.602,343.996 93.6,343.996 93.6,254.001 	"></polyline>
	<polyline style="fill:#ffbc58;" points="151.517,224.002 115.518,224.002 115.518,343.996 151.517,343.996 151.517,224.002 	"></polyline>
	<polyline style="fill:#a5a5a5;" points="209.432,191.004 173.435,191.004 173.435,343.996 209.432,343.996 209.432,191.004 	"></polyline>
	<polyline style="fill:#13c9ca;" points="242.83,325.765 242.83,454.765 0,454.765 0,325.765 242.83,325.765 	"></polyline>
	<polyline style="fill:#F2F2F2;" points="15,439.765 15,340.765 227.826,340.765 227.826,439.765 15,439.765 	"></polyline>
	<polyline style="fill:#a5a5a5;" points="108.064,430.978 87.408,408.6 78.664,420.466 71.9,415.483 86.68,395.426 106.349,416.734
		137.239,360.959 160.785,398.8 188.393,349.552 195.722,353.66 161.162,415.307 137.661,377.538 108.064,430.978 	"></polyline>
	<rect x="26" y="357.765" style="fill:#999999;" width="27" height="11"></rect>
	<rect x="26" y="384.765" style="fill:#999999;" width="27" height="11"></rect>
	<rect x="26" y="411.765" style="fill:#999999;" width="27" height="11"></rect>
	...
	<polyline style="fill:#FDA589;" points="188.393,349.552 160.785,398.8 137.239,360.959 115.542,400.135 118.951,411.32
		137.661,377.538 161.162,415.307 195.722,353.66 188.393,349.552 	"></polyline>
	<path style="fill:#CCCCCC;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192c2.934-2.934,2.927-7.679,0-10.607l-25.251-25.251l20.669-8.492l-78.559-38.792L393.695,417.909z"></path>
                ...
                <div class="col-md-7 p-0 card-right">
                    <div class="card tab2-card">
                        <div class="card-body">
                            ...
                            if($error == true) {
                                echo '<div class="alert alert-danger" style="color:white;background-color:#ff5a5a;border:none;" role="alert"><strong>Error: </strong>'.$errorMessage.'</div>';
                            }
                                ...
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form class="form-horizontal auth-form" method='POST' action>
                                        <div class="form-group">
                                            <input required="" name="username" type="username" class="form-control" placeholder="Username" id="exampleInputEmail1">
                                        </div>
                                        <div class="form-group">
...
<script src="../assets/js/slick-1.js"></script>
